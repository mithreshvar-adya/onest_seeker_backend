...
router.post("/on_init", validateSearchRequest,  OndcOnestVersionHandlerMiddleware(v1_init_handler.on_init))
router.post("/on_confirm", validateSearchRequest, OndcOnestVersionHandlerMiddleware(v1_confirm_handler.on_confirm))
router.post("/on_status", validateSearchRequest, OndcOnestVersionHandlerMiddleware(v1_status_handler.on_status))
